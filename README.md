# genpark-composable-headless-b2b-commerce-architecture-skill
...
> **GenPark AI Agent Skill** -- Composable headless B2B commerce with cXML punchout and contract pricing (Spryker style)
